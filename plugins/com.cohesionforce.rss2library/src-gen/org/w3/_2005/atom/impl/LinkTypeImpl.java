 ...
 * <ul>
 *   <li>{@link org.w3._2005.atom.impl.LinkTypeImpl#getValue <em>Value</em>}</li>
...
public class LinkTypeImpl extends MinimalEObjectImpl.Container implements LinkType {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomPackage.LINK_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtomPackage.LINK_TYPE__VALUE:
				return getValue();
