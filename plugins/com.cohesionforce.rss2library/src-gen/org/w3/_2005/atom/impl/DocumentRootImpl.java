 ...
 *   <li>{@link org.w3._2005.atom.impl.DocumentRootImpl#getFeed <em>Feed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public FeedType getFeed() {
		return (FeedType)getMixed().get(AtomPackage.Literals.DOCUMENT_ROOT__FEED, true);
	}
	...
	public NotificationChain basicSetFeed(FeedType newFeed, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(AtomPackage.Literals.DOCUMENT_ROOT__FEED, newFeed, msgs);
	}
	...
	public void setFeed(FeedType newFeed) {
		((FeatureMap.Internal)getMixed()).set(AtomPackage.Literals.DOCUMENT_ROOT__FEED, newFeed);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AtomPackage.DOCUMENT_ROOT__FEED:
