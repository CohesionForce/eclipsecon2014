 ...
 * <ul>
 *   <li>{@link org.w3._2005.atom.impl.AuthorTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AuthorTypeImpl extends MinimalEObjectImpl.Container implements AuthorType {
	...
	protected EClass eStaticClass() {
		return AtomPackage.Literals.AUTHOR_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomPackage.AUTHOR_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtomPackage.AUTHOR_TYPE__NAME:
				return getName();
		}
